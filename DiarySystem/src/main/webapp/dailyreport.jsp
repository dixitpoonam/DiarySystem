			...
			<table border="0" width="750px" align="center">
             ...
             Calendar.setup(
             {
				...
				<%
					...
					<div align="right">
					<%
					sql="select count(*) as count from t_unitreplacement where InstBy='"+rst.getString("TechName")+"' and InstDate >='"+fromdate+"' and InstDate <='"+todate+"' and 164.68.105.216='Rep'";
					...
					<div align="right">
					<%
					sql="select count(*) as count from t_unitreplacement where InstBy='"+rst.getString("TechName")+"' and InstDate >='"+fromdate+"' and InstDate <='"+todate+"' and 164.68.105.216='New'";
