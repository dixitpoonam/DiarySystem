...
if(dispatch.equalsIgnoreCase("Yes")){
	...
	<td  class="sorttable_nosort">
			<div id="report_heding" align="center"><font color="brown" size="3">TAT Report for <%
				...
				<th style="font-size: 14px; face: san-serif; border: 1px solid #ddd; padding: 10px; padding-top: 12px; padding-bottom: 12px; text-align: right; background-color: #e6e6e6; color: black;"> Last Dispatch Date </th>
				<th style="font-size: 14px; face: san-serif; border: 1px solid #ddd; padding: 10px; padding-top: 12px; padding-bottom: 12px; text-align: right; background-color: #e6e6e6; color: black;"> Unit Started from Field Date </th>
				<th style="font-size: 14px; face: san-serif; border: 1px solid #ddd; padding: 10px; padding-top: 12px; padding-bottom: 12px; text-align: right; background-color: #e6e6e6; color: black;"> Unit Started Location</th>
				<th style="font-size: 14px; face: san-serif; border: 1px solid #ddd; padding: 10px; padding-top: 12px; padding-bottom: 12px; text-align: right; background-color: #e6e6e6; color: black;"> Technician Name </th>
				<th style="font-size: 14px; face: san-serif; border: 1px solid #ddd; padding: 10px; padding-top: 12px; padding-bottom: 12px; text-align: right; background-color: #e6e6e6; color: black;"> Courier Name</th>
				<th style="font-size: 14px; face: san-serif; border: 1px solid #ddd; padding: 10px; padding-top: 12px; padding-bottom: 12px; text-align: right; background-color: #e6e6e6; color: black;"> Unit Received Date</th>
				<th style="font-size: 14px; face: san-serif; border: 1px solid #ddd; padding: 10px; padding-top: 12px; padding-bottom: 12px; text-align: right; background-color: #e6e6e6; color: black;"> Received By</th>
				<th style="font-size: 14px; face: san-serif; border: 1px solid #ddd; padding: 10px; padding-top: 12px; padding-bottom: 12px; text-align: right; background-color: #e6e6e6; color: black;"> Unit Received with Configuration</th>
				<th style="font-size: 14px; face: san-serif; border: 1px solid #ddd; padding: 10px; padding-top: 12px; padding-bottom: 12px; text-align: right; background-color: #e6e6e6; color: black;"> Last Manufactured By</th>
				<th style="font-size: 14px; face: san-serif; border: 1px solid #ddd; padding: 10px; padding-top: 12px; padding-bottom: 12px; text-align: right; background-color: #e6e6e6; color: black;"> Unit Life</th>
				<th style="font-size: 14px; face: san-serif; border: 1px solid #ddd; padding: 10px; padding-top: 12px; padding-bottom: 12px; text-align: right; background-color: #e6e6e6; color: black;"> Unit Warranty</th>
				<th style="font-size: 14px; face: san-serif; border: 1px solid #ddd; padding: 10px; padding-top: 12px; padding-bottom: 12px; text-align: right; background-color: #e6e6e6; color: black;"> Start to Reach Physically(HH:MM)</th>
				<th style="font-size: 14px; face: san-serif; border: 1px solid #ddd; padding: 10px; padding-top: 12px; padding-bottom: 12px; text-align: right; background-color: #e6e6e6; color: black;"> QT Done Date</th>
				<th style="font-size: 14px; face: san-serif; border: 1px solid #ddd; padding: 10px; padding-top: 12px; padding-bottom: 12px; text-align: right; background-color: #e6e6e6; color: black;"> QT Done By</th>
				<th style="font-size: 14px; face: san-serif; border: 1px solid #ddd; padding: 10px; padding-top: 12px; padding-bottom: 12px; text-align: right; background-color: #e6e6e6; color: black;"> Reach Physically to QT Done(HH:MM)</th>
				<th style="font-size: 14px; face: san-serif; border: 1px solid #ddd; padding: 10px; padding-top: 12px; padding-bottom: 12px; text-align: right; background-color: #e6e6e6; color: black;"> Unit Repair/Manufactured </th>
				<th style="font-size: 14px; face: san-serif; border: 1px solid #ddd; padding: 10px; padding-top: 12px; padding-bottom: 12px; text-align: right; background-color: #e6e6e6; color: black;"> Unit Repair/Manufactured By</th>
				<th style="font-size: 14px; face: san-serif; border: 1px solid #ddd; padding: 10px; padding-top: 12px; padding-bottom: 12px; text-align: right; background-color: #e6e6e6; color: black;"> Repair Done after QT(HH:MM)</th>
				<th style="font-size: 14px; face: san-serif; border: 1px solid #ddd; padding: 10px; padding-top: 12px; padding-bottom: 12px; text-align: right; background-color: #e6e6e6; color: black;"> Manufacture Count</th>
				<!-- <th style="font-size: 14px; face: san-serif; border: 1px solid #ddd; padding: 10px; padding-top: 12px; padding-bottom: 12px; text-align: right; background-color: #e6e6e6; color: black;"> Trackfile Count</th> -->
				<th style="font-size: 14px; face: san-serif; border: 1px solid #ddd; padding: 10px; padding-top: 12px; padding-bottom: 12px; text-align: right; background-color: #e6e6e6; color: black;"> QuickTest Count</th>
				<th style="font-size: 14px; face: san-serif; border: 1px solid #ddd; padding: 10px; padding-top: 12px; padding-bottom: 12px; text-align: right; background-color: #e6e6e6; color: black;"> Unit Tested Date</th>
				<th style="font-size: 14px; face: san-serif; border: 1px solid #ddd; padding: 10px; padding-top: 12px; padding-bottom: 12px; text-align: right; background-color: #e6e6e6; color: black;"> Unit Tested By</th>
				<th style="font-size: 14px; face: san-serif; border: 1px solid #ddd; padding: 10px; padding-top: 12px; padding-bottom: 12px; text-align: right; background-color: #e6e6e6; color: black;"> Tested after Repair (HH:MM)</th>
				<th style="font-size: 14px; face: san-serif; border: 1px solid #ddd; padding: 10px; padding-top: 12px; padding-bottom: 12px; text-align: right; background-color: #e6e6e6; color: black;"> Total TAT (In Days)</th>
				<th style="font-size: 14px; face: san-serif; border: 1px solid #ddd; padding: 10px; padding-top: 12px; padding-bottom: 12px; text-align: right; background-color: #e6e6e6; color: black;"> Unit Dispatch Date</th>
				<th style="font-size: 14px; face: san-serif; border: 1px solid #ddd; padding: 10px; padding-top: 12px; padding-bottom: 12px; text-align: right; background-color: #e6e6e6; color: black;"> Unit Dispatch Done by</th>
				<th style="font-size: 14px; face: san-serif; border: 1px solid #ddd; padding: 10px; padding-top: 12px; padding-bottom: 12px; text-align: right; background-color: #e6e6e6; color: black;"> Unit Received Date</th>
				<th style="font-size: 14px; face: san-serif; border: 1px solid #ddd; padding: 10px; padding-top: 12px; padding-bottom: 12px; text-align: right; background-color: #e6e6e6; color: black;"> Unit Received Confirmation By</th>
				<th style="font-size: 14px; face: san-serif; border: 1px solid #ddd; padding: 10px; padding-top: 12px; padding-bottom: 12px; text-align: right; background-color: #e6e6e6; color: black;"> Unit Received after dispatch(HH:MM)</th>
				...
				//	System.out.println("diffindays----->"+diffdays);
					...
					System.out.println("time4="+time4);
					 ...
					 if(testRst.next())
					 {
						 ...
						 if(testDateTime==null||testDateTime.equalsIgnoreCase("null") || testDateTime.equalsIgnoreCase("-")){
							 testedDt="-";
						 }else{
...
%>
			...
			<div class="form" style="width: 750px; color: black;">
					<table id="example" width="750px" border="0" align="center">
						...
						<th style="font-size: 14px; face: san-serif; border: 1px solid #ddd; padding: 10px; padding-top: 12px; padding-bottom: 12px; text-align: right; background-color: #e6e6e6; color: black;"> Unit Life</th>
						<th style="font-size: 14px; face: san-serif; border: 1px solid #ddd; padding: 10px; padding-top: 12px; padding-bottom: 12px; text-align: right; background-color: #e6e6e6; color: black;"> Unit Warranty</th>
						<th style="font-size: 14px; face: san-serif; border: 1px solid #ddd; padding: 10px; padding-top: 12px; padding-bottom: 12px; text-align: right; background-color: #e6e6e6; color: black;"> Start to Reach Physically(In Days)</th>
						<th style="font-size: 14px; face: san-serif; border: 1px solid #ddd; padding: 10px; padding-top: 12px; padding-bottom: 12px; text-align: right; background-color: #e6e6e6; color: black;"> QT Done Date</th>
						<th style="font-size: 14px; face: san-serif; border: 1px solid #ddd; padding: 10px; padding-top: 12px; padding-bottom: 12px; text-align: right; background-color: #e6e6e6; color: black;"> QT Done By</th>
						<th style="font-size: 14px; face: san-serif; border: 1px solid #ddd; padding: 10px; padding-top: 12px; padding-bottom: 12px; text-align: right; background-color: #e6e6e6; color: black;"> Reach Physically to QT Done(In Days)</th>
						<th style="font-size: 14px; face: san-serif; border: 1px solid #ddd; padding: 10px; padding-top: 12px; padding-bottom: 12px; text-align: right; background-color: #e6e6e6; color: black;"> Unit Repair/Manufactured </th>
						<th style="font-size: 14px; face: san-serif; border: 1px solid #ddd; padding: 10px; padding-top: 12px; padding-bottom: 12px; text-align: right; background-color: #e6e6e6; color: black;"> Unit Repair/Manufactured By</th>
						<th style="font-size: 14px; face: san-serif; border: 1px solid #ddd; padding: 10px; padding-top: 12px; padding-bottom: 12px; text-align: right; background-color: #e6e6e6; color: black;"> Repair Done after QT(In Days)</th>
						<th style="font-size: 14px; face: san-serif; border: 1px solid #ddd; padding: 10px; padding-top: 12px; padding-bottom: 12px; text-align: right; background-color: #e6e6e6; color: black;"> Manufacture Count</th>
						<!-- <th style="font-size: 14px; face: san-serif; border: 1px solid #ddd; padding: 10px; padding-top: 12px; padding-bottom: 12px; text-align: right; background-color: #e6e6e6; color: black;"> Trackfile Count</th> -->
						<th style="font-size: 14px; face: san-serif; border: 1px solid #ddd; padding: 10px; padding-top: 12px; padding-bottom: 12px; text-align: right; background-color: #e6e6e6; color: black;"> QuickTest Count</th>
						<th style="font-size: 14px; face: san-serif; border: 1px solid #ddd; padding: 10px; padding-top: 12px; padding-bottom: 12px; text-align: right; background-color: #e6e6e6; color: black;"> Unit Tested Date</th>
						<th style="font-size: 14px; face: san-serif; border: 1px solid #ddd; padding: 10px; padding-top: 12px; padding-bottom: 12px; text-align: right; background-color: #e6e6e6; color: black;"> Unit Tested By</th>
						<th style="font-size: 14px; face: san-serif; border: 1px solid #ddd; padding: 10px; padding-top: 12px; padding-bottom: 12px; text-align: right; background-color: #e6e6e6; color: black;"> Tested after Repair (In Days)</th>
						<th style="font-size: 14px; face: san-serif; border: 1px solid #ddd; padding: 10px; padding-top: 12px; padding-bottom: 12px; text-align: right; background-color: #e6e6e6; color: black;"> Total TAT (In Days)</th>
						<th style="font-size: 14px; face: san-serif; border: 1px solid #ddd; padding: 10px; padding-top: 12px; padding-bottom: 12px; text-align: right; background-color: #e6e6e6; color: black;"> Unit Dispatch Date</th>
						<th style="font-size: 14px; face: san-serif; border: 1px solid #ddd; padding: 10px; padding-top: 12px; padding-bottom: 12px; text-align: right; background-color: #e6e6e6; color: black;"> Unit Dispatch Done by</th>
						<th style="font-size: 14px; face: san-serif; border: 1px solid #ddd; padding: 10px; padding-top: 12px; padding-bottom: 12px; text-align: right; background-color: #e6e6e6; color: black;"> Unit Received Date</th>
						<th style="font-size: 14px; face: san-serif; border: 1px solid #ddd; padding: 10px; padding-top: 12px; padding-bottom: 12px; text-align: right; background-color: #e6e6e6; color: black;"> Unit Received Confirmation By</th>
						<th style="font-size: 14px; face: san-serif; border: 1px solid #ddd; padding: 10px; padding-top: 12px; padding-bottom: 12px; text-align: right; background-color: #e6e6e6; color: black;"> Unit Received after dispatch(In Days)</th>
