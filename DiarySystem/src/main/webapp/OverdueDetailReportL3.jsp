      ...
      function validate()
 			...
 			function tempremoval()
 			{
 				...
 				function birt(){
 					...
 					document.getElementById("myIframe").src="http://164.68.105.216:8080/ERPTestBirt/frameset?__report=oldsummaryreport.rptdesign&Date1="+formattedDate1+"&Date2="+formattedDate2+"&Date3="+date1+"&Date4="+date2+"&__showtitle=false;";
 					
 					<%-- <iframe id="myIframe" width="220%" height="850px" src="http://164.68.105.216:8080/ERPTestBirt/frameset?__report=oldsummaryreport.rptdesign&Date1=<%=datex1%>&Date2=<%=datex2%>&__showtitle=false";> 
 					</iframe> --%>
 					//document.getElementById('myIframe').src="http://164.68.105.216:8080/ERPTestBirt/frameset?__report=Tic_report.rptdesign";
...
<%-- <iframe id="myIframe" width="220%" height="850px" src="http://164.68.105.216:8080/ERPTestBirt/frameset?__report=TIC_report.rptdesign&Transporter=<%=transporter %>&Chk=<%=chk %>&Stg1=<%=chk %>&Stg2=<%=chk %>&Stg3=<%=chk %>&Stg4=<%=chk %>&__showtitle=false";> 
</iframe> --%>

<iframe id="myIframe" width="220%" height="850px" src="http://164.68.105.216:8080/ERPTestBirt/frameset?__report=OverdueL3Report.rptdesign&customer=<%=Transp1%>&Date1=<%=fromdate456%>&Date2=<%=fromdate123%>&Date3=<%=fromdate789%>&Date4=<%=fromdate123000%>&contact=<%=contactname%>&__showtitle=false";> 
</iframe>
</div>
	<%-- <table border="0" width="800px" bgcolor="#E6E6E6" align="center">
<%
...
<%-- <iframe id="myIframe" width="100%" height="850px" src="http://myfleetview.com:8080/birt/frameset?__report=JRM_report.rptdesign&userid=<%=UserID%>&__showtitle=false"> --%> 
<%-- <iframe id="myIframe" width="220%" height="850px" src="http://164.68.105.216:8080/ERPTestBirt/frameset?__report=oldsummaryreport.rptdesign&Date1=<%=dt%>&Date2=<%=dt1%>&Date3=<%=datex1%>&__showtitle=false";>  --%>
