...
<%		
	try
	{
		...
		System.out.println("conn1:"+con1);
		System.out.println("conn2:"+con2);
...
%>		
		...
		<table id="example"  style="width: 100%" width="100%" align="center" class="display">
			<thead>
				<tr>
