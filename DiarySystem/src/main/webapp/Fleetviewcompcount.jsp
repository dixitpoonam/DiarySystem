...

{
	...
	document.getElementById('myIframe').src="http://164.68.105.216:8181/NewBirtTestFleetView/frameset?__report=FleetViewComplaint.rptdesign&__showtitle=false";	
...

	{
		...
		document.getElementById('myIframe').src="http://164.68.105.216:8181/birttest/frameset?__report=FleetViewComplaint.rptdesign&__showtitle=false";	
		document.getElementById("reportData").style.display= "";
		return true;
