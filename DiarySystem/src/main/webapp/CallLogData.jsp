...
<br></br>
	...
	<table border="1" width="750px" align="center" class="sortable">
		<div id="reportData1">
 <iframe id="myIframe" width="100%" height="500px" src="http://164.68.105.216:8080/birt/frameset?__report=vehwisecalllog.rptdesign&VehicleId=<%=vehcode%> &VehRegNo=<%=vehno%>&Transporter=<%=transporter%>&Caller=<%=username%> &__showtitle=false">
<!-- <iframe id="myIframe" width="180%" height="500px" src="http://164.68.105.216:8080/NewBirtTestERP/frameset?__report=CallLog.rptdesign&__showtitle=false"> --> 
