...
function insert(){
	...
	location.href = 'CreateNewIdDS.jsp';
}
...
else
{
	...
	else
	{
		...
		if(flag == "1")
		{
			/* response.sendRedirect("CreateNewIdDS.jsp?inserted="+flag); */
			out.println("<script>NotInsert()</script>");
		}
		else
		{
			/* response.sendRedirect("CreateNewIdDS.jsp?inserted="+flag); */
			out.println("<script>insert()</script>");
		}
return;
