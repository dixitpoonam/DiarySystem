...
<script>
function myFunction() {
  window.open("SpecialComment.jsp");
}
...
<%@ include file="MenuNew.jsp"%>
			...
			<tr>
				<td>
					<table border="0" width="100%">
						<tr>
							<td align="center"><font color="black" size="3">Summary
							</font></td>
						</tr>
					</table>
				</td>
		...
		<% 
                        String sql="select (select count(distinct(vehiclecode)) from db_gps.t_vehicledetails where status='-' and ownername in (select distinct(TypeValue) from db_gps.t_transporter where OperationalStatus='Active') ) as Total,(select count(distinct(vehiclecode)) from db_gps.t_onlinedata where thedate =DATE(now())  and vehiclecode in (select distinct(vehiclecode) from db_gps.t_vehicledetails where status='-' and ownername in (select distinct(TypeValue) from db_gps.t_transporter where OperationalStatus='Active'))) as OnLine,(select count(distinct(vehiclecode)) from db_gps.t_onlinedata where thedate !=DATE(now())  and vehiclecode in (select distinct(vehiclecode) from db_gps.t_vehicledetails where status='-' and ownername in (select distinct(TypeValue) from db_gps.t_transporter where OperationalStatus='Active'))) as OffLine from db_gps.t_vehicledetails where status='-' limit 1  ";     
						...
						System.out.println("online" + num1);
						System.out.println("offline" + num2);
						
						 String sql01 ="select count(distinct(VehRegNo)) from db_CustomerComplaints.t_techspecialrep where Closed='No' and cmmt_type='Vehicle' and EntDateTime IS Not NULL and VehRegNo in (select distinct(vehicleregnumber) from db_gps.t_vehicledetails where status='-') ";
	                        ResultSet st = smt.executeQuery(sql01);
	                        if(st.next())
	                        {
	                        	num3 = (st.getInt(1));
	                        }
	                        
	                        System.out.println("Special Comment " + num3);
	                        
						
										
		%>

		<div class="grid-container" style="width: 750px; padding-left: 280px;">
			<div class="item1">
				Total <br>
				<%=num%></div>

			<div class="item2">
				<a href="OnlineReport.jsp" target="_blank"><b>Online <br><%=num1%></b></a>
			</div>

			<div class="item3">
				<a href="summary.jsp"><b>Offline <br><%=num2%></b></a>
			</div>

			<div class="item4">
				<a href="SpecialComment.jsp" target="_blank"> <b>Special
						Comment <br> <%=num3%></b></a>
			</div>
		</div>
		...
		<table border="0" width="750px" bgcolor="" align="center">
			<tr>
				<td>
					<table border="0" width="100%">
						<tr>
							<td align="center"><font color="black" size="3">Offline
		...
		<table id="example" class="display" style="width: 100%">
			<thead>
				<tr>
					...
					<th align="center" style="display: none">Vehicle No</th>  <!-- th column  for dummy Vehicle No -->
					<th align="center">User Name</th>
					<th align="center">User Mobile Number</th>
					<th align="center">User email id</th>
					<th align="center">State</th>
					<th align="center">City</th>
					<th align="center">Offline Since</th>
	...
	//==========//
        	%>
				...
				<tr>
					...
					<td style="text-align: right">  <!--Vehicle no. with link-->
					<a href="javascript:toggleDetails(<%=i%>,true);" title="Click Here"><%=vehreg%> 
					</a> <br />
...
<tr>
					...
					<td style="text-align: left; display: none"><%=vehreg%></td>   <!-- td for dummy Vehicle No -->
		...
		%>
			...
			<tfoot>
				...
				<tr>
					...
					<th align="center">Customer Name</th>
					<th align="center">Vehicle No</th>
					<th align="center" style="display: none">Vehicle No</th>  <!-- column for dummy Vehicle No-->
					<th align="center">User Name</th>
					<th align="center">User Mobile Number</th>
					<th align="center">User email id</th>
					<th align="center">State</th>
