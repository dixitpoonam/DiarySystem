...
<td align="right" bgcolor="#FFFFFF"><%=new SimpleDateFormat("dd-MMM-yyyy HH:mm").format(new java.util.Date())%></td>
	 	...
	 	<div id="reportData1" align="Center">
			<iframe id="myIframe" width="100%" height="900px" src="http://164.68.105.216:8181/NewBirtTestFleetView/frameset?__report=Closed.rptdesign&__showtitle=false"> 
...
<td align="right" bgcolor="#FFFFFF"><%=new SimpleDateFormat("dd-MMM-yyyy HH:mm").format(new java.util.Date())%></td>
	 	...
	 	<div id="reportData1" align="Center">
			<iframe id="myIframe" width="100%" height="900px" src="http://164.68.105.216:8181/NewBirtTestFleetView/frameset?__report=Escalated.rptdesign&__showtitle=false"> 
...
<td align="right" bgcolor="#FFFFFF"><%=new SimpleDateFormat("dd-MMM-yyyy HH:mm").format(new java.util.Date())%></td>
	 	...
	 	<div id="reportData1" align="Center">
			<iframe id="myIframe" width="100%" height="900px" src="http://164.68.105.216:8181/NewBirtTestFleetView/frameset?__report=Solved.rptdesign&__showtitle=false"> 
...
<td align="right" bgcolor="#FFFFFF"><%=new SimpleDateFormat("dd-MMM-yyyy HH:mm").format(new java.util.Date())%></td>
	 	...
	 	<div id="reportData1" align="Center">
			<iframe id="myIframe" width="100%" height="900px" src="http://164.68.105.216:8181/birttest/frameset?__report=Pending.rptdesign&__showtitle=false"> 
