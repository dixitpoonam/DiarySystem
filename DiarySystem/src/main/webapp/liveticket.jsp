      ...
      function validate()
 			...
 			function tempremoval()
 			{
 				...
 				function birt(){
 					...
 					document.getElementById("myIframe").src="http://164.68.105.216:8080/ERPTestBirt/frameset?__report=TIC_report.rptdesign&Transporter="+transporter+"&Chk="+chk+"&Stg1="+stg1+"&Stg2="+stg2+"&Stg3="+stg3+"&Stg4="+stg4+"&__showtitle=false";
