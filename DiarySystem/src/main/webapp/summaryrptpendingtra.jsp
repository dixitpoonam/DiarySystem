...
<iframe id="myIframe" width="220%" height="850px" src="http://164.68.105.216:8080/ERPTestBirt/frameset?__report=overdueL2.rptdesign&customer=<%=Transp1%>&Date1=<%=fromdate456%>&Date2=<%=fromdate123%>&Date3=<%=fromdate789%>&Date4=<%=fromdate123000%>&__showtitle=false";> 
</iframe>
</div>
	<%-- <table border="0" width="800px" bgcolor="#E6E6E6" align="center">
<%
