...
<body style="background-color: #FFFFFF;">
	...
	String Vehcode = "", unitid = "", instdate = "";%>
				...
				<form name="sla1" id="sla1" method="post">
					...
					<div id="table1">
										...
										<table border="0" width="100%">
											<tr>
												<td align="center"><font color="black" size="3">List
														of All Vehicles Showing ToDays Data.</font></td>
											</tr>
										</table>
									</td>
								</tr>
						...
						%>
                           ...
                           <div class="form" style="width: 750px; color: black; padding-left:250px">
								...
								<th
									...
									<%
										try {
												...
												sql = "select a.*,b.UnitID,b.OwnerName,b.installeddate from t_onlinedata a, t_vehicledetails b where a.TheDate ='"
														+ tdydate
														+ "'and a.VehicleCode= b.VehicleCode and b.status ='-' and a.Location not like 'No GPS %' order by b.ownername asc ,a.TheDate Desc";
												//out.print(sql);
				...
				%>
				<table border="0" width="750px" style="padding-left: 350px;">
					<tr>
						<td align="center" colspan="2"><center>
								<font color="black" size="3">List of All Vehicles Showing
									ToDays Data.</font>
							</center></td>
					</tr>
					<!-- <tr>
						<td colspan="" bgcolor="">
							<div align="right">
								<a href="totalcurrentexcel.jsp?"> <img
									src="images/excel.jpg" width="15px" height="15px" border="0" />
								</a>
							</div>
						</td>
					</tr> -->
