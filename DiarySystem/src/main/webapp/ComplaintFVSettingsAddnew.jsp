...
<%
 ...
 try
 {
 	...
 	try{
 		  ...
 		  if(valid.equalsIgnoreCase("Yes"))  
 		    {
 				String sql1 = "select * from db_gps.t_ComplaintSettings where Category='" + category
 						+ "' AND dept='" + dept + "'";
 				/* String sql1="select * from db_gps.t_ComplaintSettings where Category='"+category+"' "; */
 				System.out.println("complaint setting check-->" + sql1);
 				ResultSet rs = st1.executeQuery(sql1);
 				if (rs.next()) {
 					System.out.println("inside ifffffffffffff");
 					String sql = "update db_gps.t_ComplaintSettings SET Limit1='" + limit_1 + "',Limit2='"
 							+ limit_2 + "',Limit3='" + limit_3 + "',EmailID1='" + email_1 + "',EmailID2='"
 							+ email_2 + "',EmailID3='" + email_3 + "' ,TimeDiffL1='" + lmt1 + "',TimeDiffL2='"
 							+ lmt2 + "',TimeDiffL3='" + lmt3 + "' where Category='" + category + "' AND dept='"
 							+ dept + "' ";
 					...
 					String sql = "insert into db_gps.t_ComplaintSettings(Category,Limit1,Limit2,Limit3,EmailID1,EmailID2,EmailID3,dept,TimeDiffL1,TimeDiffL2,TimeDiffL3)values('"
 							+ category + "','" + limit_1 + "','" + limit_2 + "','" + limit_3 + "','" + email_1
 							+ "','" + email_2 + "','" + email_3 + "','" + dept + "','" + lmt1 + "','" + lmt2
 							+ "' ,'" + lmt3 + "' )";
 		...
 		//con.close();
 		response.sendRedirect("ComplaintSettingsAddNew.jsp?Msg=1&valid=" + valid + "&limit_1=" + limit_1
 				+ "&limit_2=" + limit_2 + "&limit_3=" + limit_3 + "&email_1=" + email_1 + "&email_2=" + email_2
 				+ "&email_3=" + email_3);
 	}
 %>
</body>
