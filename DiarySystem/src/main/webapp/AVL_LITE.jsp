...
Statement st,stcodever,stcodever1,stmtsp1,stmtsp11,stmtsp111,stmt1,stmt2,stmtsp, st1,st23,st24, st2, st3,st4,st5,st6, st9, st11, st01, st12,stamc,stamc1 ,stwar1,stwar2,stwar3,stwar4;
...
<%
	...
	try{
		...
		stcodever = conn1.createStatement();
		stcodever1 = conn1.createStatement();
...
<%	}
	...
	<%
		...
		ResultSet rstcdever = stcodever.executeQuery(cdever);
		codeVersion = "";
		if(rstcdever.next())
		{
...
String bg1="";
	...
	<% 
		String cdever = "select * from db_gps.t_ftplastdump where unitid='"+unitid+"' ";
		ResultSet rstcdever = stcodever1.executeQuery(cdever);
