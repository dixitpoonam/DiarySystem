...
<!--	-->
	...
	<table class="sortable" border="1" align="center" width="750px" >
		...
		<%
			...
			if(codeVersion.equals("Temp"))
			{
			   sql_unit = "select * from db_gps.t_unitmaster where Peripherals in('1 Temp','2 Temp','1 Temp+Plain') ";
				
			}
			else
		     sql_unit = "select * from db_gps.t_unitmaster where SwVer like '"+codeVersion+"%' ";
...
%>
	...
	if(codeVersion.equals("Temp"))
	{
	   sql_unit = "select * from db_gps.t_unitmaster where Peripherals in ('1 Temp','2 Temp','1 Temp+Plain') and unitid NOT IN"+unitidWithOnlineData+"";
		
	}
	else
	 sql_units = "select * from db_gps.t_unitmaster where swver like '"+codeVersion+"%'  and unitid NOT IN"+unitidWithOnlineData+" ";
