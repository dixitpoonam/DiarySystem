...
try
{
	...
	*/
	...
	<td><%
		String remdate="";
		sql2="select * from t_unitreplacement where VehRegNo='"+rst1.getString("VehicleRegNumber")+"' or VehCode='"+rst1.getString("VehicleCode")+"' and 164.68.105.216='Rem' order by EntDate desc";
