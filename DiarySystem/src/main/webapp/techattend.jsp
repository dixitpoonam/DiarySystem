	...
	<!-- <table border="0" width="350px" >
      ...
      <div class="generic-container" style="margin-left: 275px; margin-top: 60px;">
          <div class="panel panel-default">
              <div class="panel-heading" align="center" ><span class="lead">Technician Attendance </span></div>
				...
				<option value="Select">Select</option> -->
				   ...
				   <div class="row">
                          <div class="form-group col-md-12">
                              <label class="col-md-2 control-lable" for="file"> Tech:</label>
                              <div class="col-md-7">
                       <select class="form-control input-sm" name="tech" class="formElement" onChange="GetLocForTech();">
...
<!-- 			<td align="center"> <font color="maroon"> Present:</font> </td>
 -->			<!-- <td align="left"> <input type="radio" name="present" value="Yes" checked>Yes</input> &nbsp;&nbsp;&nbsp;
			...
			<input type="radio" name="present" value="OUT">CheckOut</input>
			 ...
			 <div class="row">
                          <div class="form-group col-md-12">
                              <label class="col-md-2 control-lable" for="file"> Holiday</label>
                              <div class="col-md-7">
...
<!-- 					<td align="center"> <font color="maroon"> LastDay Night Working:</font> </td>
 -->		
		<div class="row">
                          <div class="form-group col-md-12">
                              <label class="col-md-2 control-lable" for="file"> LastDay Night Working:</label>
                              <div class="col-md-7">
...
%>
		...
		<!-- <tr>
		 ...
		 <div class="row">
                          <div class="form-group col-md-12">
                              <label class="col-md-2 control-lable" for="file">Okay Units:</label>
                              <div class="col-md-7">
		...
		<!-- <tr>
		 ...
		 <div class="row">
                          <div class="form-group col-md-12">
                              <label class="col-md-2 control-lable" for="file">Faulty Units:</label>
                              <div class="col-md-7">
