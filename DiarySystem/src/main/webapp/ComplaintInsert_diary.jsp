...
System.out.println("\n\n ismultipart-->>"+isMultipart);
	...
	if(null!=Description || null!=Category || null!=Priority)
	{
		...
		MM_dbConn_STRING12="jdbc:mysql://164.68.105.216/db_gps";
   ...
   try {
			...
			Statement stEmailDetails=conn1.createStatement();
			...
			System.out.println("getEmailDetails query :- "+getEmailDetails);
			...
			while(rs.next())
			{
				System.out.println("in the while loop of t_EmailReportSettings"); 
   ...
   }catch(Exception e)
	{
		System.out.println("Exception "+e.getMessage());
			...
			String html = "<html><head><style type=text/css>table.mytable{font:13px arial,sans-serif;border-collapse: collapse; border: 1px solid #839E99;background: #f1f8ee;}</style> </head>"+
				...
				" <u><a href=http://"+Website+">"+Website+"</a></u>  "+ comdate +"  <br></font><br><table><tr><td align = left style = ^margin-left:20px;^>";
				
				
				
			 html =html+"<h5 style=^font-family:verdana;^>Dear "+name+"</h5><br><p style=^font-family:arial;color:black;font-size:14px;^><br>Thank you for contacting Transworld-Compressor Technology Ltd. This is an automated response confirming that your complaint is successfully registered with us. One of our team members will get back to you as soon as possible and will update you about the status of your complaint. "
				 +"<br>For your records, the details of the complaint are listed below.For any furhter communication with us, kindly keep the track of your Complaint ID so that we can help you to give correct status of your complaint."
...
*/
		...
		/*					 +"Hello "+name+",<br><br>Thank you for contacting us. This is an automated response confirming the receipt of your complaint. One of our team members will get back to you as soon as possible. "
            ...
            */          
                       System.out.println("the data is :"+html);
               //inset data into all pending mail table   
                  ...
                  try
                  {
                	  System.out.println("subject is :-  Complaint Confirmation - Transworld-Compressor Technologies Ltd,Pune");
                	  String q = "insert into db_gps.t_allpendingmailtable(MailName,Description,MailBody,subjectline,Toid,Tocc,EntryDateTime,MailStatus,SenderName)values('Transworld','New Complaint Email','"+html+"','Complaint Confirmation - Transworld-Compressor Technologies Ltd,Pune','"+emailnew+"','"+Email3+"','"+DateTime+"','Pending','Transworld')";
