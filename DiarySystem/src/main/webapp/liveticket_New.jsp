...
try{
	...
	while(rst12_new1.next())
	{
		...
		String swe="select count(distinct(a.tcategory))  as total  from db_gps.t_livetickettest a,db_gps.t_vehicledetails b  where a.vehid=b.vehiclecode  and and b.instruction not in('remove','recall')  b.ownername='"+rst12_new1.getString("ownername")+"'";
