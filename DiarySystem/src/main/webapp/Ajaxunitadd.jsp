...
while(rs1.next())
{
	...
	if(pripherl!=null)
	{
		if(pripherl.equalsIgnoreCase("Smart Card") || pripherl.equalsIgnoreCase("SmartCard"))
		{
			pripherl = pripherl.toUpperCase() ;
			pripherl = pripherl.replaceAll(" ","");
			System.out.println("hk hk hk pripherl:- "+pripherl);
		}
