...
Connection con= DriverManager.getConnection("jdbc:mysql://164.68.105.216/db_gps","fleetview","1@flv");
...
<!-- <th><font color="White">BilledAmt</font></th> -->
	...
	{	
		...
		Class.forName("org.gjt.mm.mysql.Driver");
	     ...
	     // conn1 = DriverManager.getConnection("jdbc:mysql://164.68.105.216/db_gps", "fleetview", "1@flv");
	     con= DriverManager.getConnection("jdbc:mysql://164.68.105.216/db_gps","fleetview","1@flv");
