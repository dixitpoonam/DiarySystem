...
try
{
	...
	*/
	...
	<%
		String deactdate="";
		String deactunit="";
		sql2="select * from t_unitreplacement where VehRegNo='"+rst1.getString("VehicleRegNumber")+"' or VehCode='"+rst1.getString("VehicleCode")+"' and 164.68.105.216='DeActive' order by EntDate desc";
