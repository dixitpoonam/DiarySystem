...
<link rel="stylesheet"
	href="https://cdn.datatables.net/buttons/1.5.1/css/buttons.dataTables.min.css "></link>
...
<%
	...
	%>
		...
		<table class="exTable"  border="0" width="750px">
				<tr>
					<td align="center"> <font color="maroon" size="4">  GROUP LIST </font> </td>
				</tr>
		</table>
		
	<table class="display" class="exTable" id="example" >
					<thead>
							<tr>
	...
	<tr>
		...
		%>	
				...
				<table class="exTable" border="2" width="750px"> 
						<tr>
							<td><div align="center">
