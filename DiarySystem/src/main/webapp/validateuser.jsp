<%-- 
    ...
    Author     : Azar
    Discription: this page having code to validate the user according to user role. and redirect the user to next page.
...
try
{
	...
	Statement s1 = con1.createStatement();
	  ...
	  sql="select Distinct(OwnerName) as OwnerName from t_vehicledetails where where OwnerName not like '%del' and GPName='"+user+"' order by OwnerName";
	   ...
	   System.out.println("Query As per userrole:"+userrole+" is:"+sql);
