...
try{
	...
	conn= DriverManager.getConnection("jdbc:mysql://164.68.105.216/db_gps","diary","d@1ry");
	//conn= DriverManager.getConnection("jdbc:mysql://164.68.105.216/db_gps","fleetview","d@1ry");
