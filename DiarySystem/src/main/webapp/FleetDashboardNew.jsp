...
%>
  ...
  <div class="form" style="width: 333px; height: 360px" >
  
<div style="height: 27px;align:center"> <font color="#2A0A12"><b> VEHICLE STATUS </b></font>  </b></font></div>

  <div align="right"><input id="save-pdfUtilizationTime" type="button" class="button button-block" value="Export" disabled /></div>
