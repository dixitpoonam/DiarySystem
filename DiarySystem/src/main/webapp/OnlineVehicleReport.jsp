...
<%
				...
				<table id="example" class="display"  style="width:750px">
					<thead>
						<tr>
							<th>Sr.No</th>
							<th  style="padding-left: 65px">Unit ID</th>
							<th  style="padding-left: 65px">Customer Name</th>
							<th  style="padding-left: 65px">Vehicle No</th>
							<th  style="padding-left: 65px">User Name</th>
							<th  style="padding-left: 65px">User Mobile Number </th>
							<th  style="padding-left: 65px">User email id</th>
							<th  style="padding-left: 65px">State</th>
							<th  style="padding-left: 65px">City</th>
							<th  style="padding-left: 65px">Offline Since</th>
							<th  style="padding-left: 65px">Last attended</th>
							<th  style="padding-left: 65px">Last Call</th>
							<th  style="padding-left: 65px">Last Allocation</th>
							<th  style="padding-left: 65px">Provider</th>
